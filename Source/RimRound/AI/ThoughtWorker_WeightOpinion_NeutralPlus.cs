...
namespace RimRound.AI
{
    class ThoughtWorker_WeightOpinion_NeutralPlus : ThoughtWorker
    {
        protected override ThoughtState CurrentStateInternal(Pawn p)
        {
            ...
            if ((p.TryGetComp<ThingComp_PawnAttitude>()?.weightOpinion ?? WeightOpinion.None) != WeightOpinion.NeutralPlus)
                return false;
            else
                this.def = Defs.ThoughtDefOf.RR_WeightOpinion_NeutralPlus;
