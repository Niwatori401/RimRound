...
namespace RimRound.Patch
{
	...
	[HarmonyPatch("DoPrisonerTab")]
	class ITab_Pawn_Visitor_DoPrisonerTab_AddLabelsForGainingReluctance
	{
		public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
		{
			...
			if (!foundInsertionPoint)
				Log.Error($"Failed to find insertion point in {nameof(ITab_Pawn_Visitor_DoPrisonerTab_AddLabelsForGainingReluctance)}.");
		...
		static MethodInfo AddLabelsAboverecruitmentResistanceMI = typeof(ITab_Pawn_Visitor_DoPrisonerTab_AddLabelsForGainingReluctance).GetMethod(nameof(ITab_Pawn_Visitor_DoPrisonerTab_AddLabelsForGainingReluctance.AddLabelsAboverecruitmentResistance), BindingFlags.NonPublic | BindingFlags.Static);
