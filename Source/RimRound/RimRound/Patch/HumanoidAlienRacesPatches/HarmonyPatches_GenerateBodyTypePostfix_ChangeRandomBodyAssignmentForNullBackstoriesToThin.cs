...
namespace RimRound.Patch
{
	...
	[HarmonyPatch(nameof(AlienRace.HarmonyPatches.GenerateBodyTypePostfix))]
    internal class HarmonyPatches_GenerateBodyTypePostfix_ChangeRandomBodyAssignmentForNullBackstoriesToThin
    {
