...
namespace RimRound.Utilities
{
    ...
    {
        // This value is how far the current minimum base weight is from 0.040.
        const float BASE_WEIGHT_SEVERITY_OFFSET = 0.015f;
        ...
        public static Dictionary<BodyTypeDef, BodyTypeInfo> defaultFemaleSet = new Dictionary<BodyTypeDef, BodyTypeInfo>()
            {
                ...
                { RimRound.Defs.BodyTypeDefOf.F_002_Emaciated,     new BodyTypeInfo(-0.010f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.0000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_003_Starved,       new BodyTypeInfo(-0.005f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.0000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_004_Scrawny,       new BodyTypeInfo(0.005f + BASE_WEIGHT_SEVERITY_OFFSET, 1.0000f, 1.00f, 1.28205f, 0.30f, 0.30f) },

                { RimWorld.BodyTypeDefOf.Thin,                     new BodyTypeInfo(0.015f + BASE_WEIGHT_SEVERITY_OFFSET, 1.0000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimWorld.BodyTypeDefOf.Female,                   new BodyTypeInfo(0.035f + BASE_WEIGHT_SEVERITY_OFFSET, 1.0000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_005_Thick,         new BodyTypeInfo(0.050f + BASE_WEIGHT_SEVERITY_OFFSET, 0.8750f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_006_Chonky,        new BodyTypeInfo(0.065f + BASE_WEIGHT_SEVERITY_OFFSET, 1.1250f, 0.90f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_010_Chubby,        new BodyTypeInfo(0.090f + BASE_WEIGHT_SEVERITY_OFFSET, 1.2500f, 0.80f, 1.28205f, 0.30f, 0.35f) },
                { RimRound.Defs.BodyTypeDefOf.F_020_Corpulent,     new BodyTypeInfo(0.120f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.65f, 0.98205f, 0.40f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.F_030_Fat,           new BodyTypeInfo(0.155f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.50f, 0.88205f, 0.44f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.F_040_Obese,         new BodyTypeInfo(0.200f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.40f, 0.77205f, 0.50f, 0.40f) },
                { RimRound.Defs.BodyTypeDefOf.F_050_MorbidlyObese, new BodyTypeInfo(0.280f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.30f, 0.65205f, 0.70f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.F_060_Lardy,         new BodyTypeInfo(0.430f + BASE_WEIGHT_SEVERITY_OFFSET, 2.7500f, 0.20f, 0.58205f, 1.00f, 0.70f) },
                { RimRound.Defs.BodyTypeDefOf.F_070_Enormous,      new BodyTypeInfo(0.660f + BASE_WEIGHT_SEVERITY_OFFSET, 2.5000f, 0.10f, 0.48205f, 0.93f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.F_080_Gigantic,      new BodyTypeInfo(0.965f + BASE_WEIGHT_SEVERITY_OFFSET, 5.5000f, 0.10f, 0.38205f, 1.10f, 0.65f) },
                { RimRound.Defs.BodyTypeDefOf.F_090_Titanic,       new BodyTypeInfo(1.410f + BASE_WEIGHT_SEVERITY_OFFSET, 5.2500f, 0.10f, 0.37205f, 1.10f, 0.79f) },
                { RimRound.Defs.BodyTypeDefOf.F_100_Gelatinous,    new BodyTypeInfo(1.860f + BASE_WEIGHT_SEVERITY_OFFSET, 7.5000f, 0.05f, 0.22205f, 2.52f, 0.00f) },

                { RimRound.Defs.BodyTypeDefOf.F_150_Gelatinous,    new BodyTypeInfo(2.460f + BASE_WEIGHT_SEVERITY_OFFSET, 8.5000f, 0.05f, 0.22205f, 2.52f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_200_Gelatinous,    new BodyTypeInfo(2.960f + BASE_WEIGHT_SEVERITY_OFFSET, 9.5000f, 0.05f, 0.20205f, 2.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_250_Gelatinous,    new BodyTypeInfo(3.960f + BASE_WEIGHT_SEVERITY_OFFSET, 10.500f, 0.05f, 0.17000f, 2.80f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_300_Gelatinous,    new BodyTypeInfo(4.960f + BASE_WEIGHT_SEVERITY_OFFSET, 12.000f, 0.05f, 0.14000f, 3.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_350_Gelatinous,    new BodyTypeInfo(6.460f + BASE_WEIGHT_SEVERITY_OFFSET, 13.000f, 0.05f, 0.13000f, 3.90f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_400_Gelatinous,    new BodyTypeInfo(7.960f + BASE_WEIGHT_SEVERITY_OFFSET, 15.000f, 0.05f, 0.11000f, 4.70f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_450_Gelatinous,    new BodyTypeInfo(9.960f + BASE_WEIGHT_SEVERITY_OFFSET, 17.000f, 0.05f, 0.10000f, 5.40f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_500_Gelatinous,    new BodyTypeInfo(14.46f + BASE_WEIGHT_SEVERITY_OFFSET, 20.000f, 0.05f, 0.09000f, 6.31f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_900_Gelatinous,    new BodyTypeInfo(21.85f + BASE_WEIGHT_SEVERITY_OFFSET  , 25.000f, 0.05f, 0.07000f, 7.11f, 0.00f) },

                { RimRound.Defs.BodyTypeDefOf.F_910_Gelatinous,    new BodyTypeInfo(42.40f + BASE_WEIGHT_SEVERITY_OFFSET  , 30.000f, 0.05f, 0.06000f, 8.5f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_920_Gelatinous,    new BodyTypeInfo(70.50f + BASE_WEIGHT_SEVERITY_OFFSET  , 40.000f, 0.05f, 0.05100f, 12f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_930_Gelatinous,    new BodyTypeInfo(116.6f + BASE_WEIGHT_SEVERITY_OFFSET  , 55.000f, 0.05f, 0.03400f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_940_Gelatinous,    new BodyTypeInfo(164.5f + BASE_WEIGHT_SEVERITY_OFFSET  , 70.000f, 0.05f, 0.02800f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_950_Gelatinous,    new BodyTypeInfo(286.2f + BASE_WEIGHT_SEVERITY_OFFSET  , 85.000f, 0.05f, 0.02200f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_960_Gelatinous,    new BodyTypeInfo(411.0f + BASE_WEIGHT_SEVERITY_OFFSET , 105.000f, 0.05f, 0.01800f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_970_Gelatinous,    new BodyTypeInfo(576.7f + BASE_WEIGHT_SEVERITY_OFFSET , 125.000f, 0.05f, 0.01500f, 41f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_980_Gelatinous,    new BodyTypeInfo(773.2f + BASE_WEIGHT_SEVERITY_OFFSET , 150.000f, 0.05f, 0.01200f, 41f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_990_Gelatinous,    new BodyTypeInfo(999.9f + BASE_WEIGHT_SEVERITY_OFFSET , 175.000f, 0.05f, 0.00700f, 60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_995_Gelatinous,    new BodyTypeInfo(10000f + BASE_WEIGHT_SEVERITY_OFFSET , 200.000f, 0.05f, 0.00700f, 60f, 0.00f) },
            };
        ...
        public static Dictionary<BodyTypeDef, BodyTypeInfo> appleFemaleSet = new Dictionary<BodyTypeDef, BodyTypeInfo>()
            {
                ...
                { RimRound.Defs.BodyTypeDefOf.F_005_Thick,          new BodyTypeInfo(0.050f + BASE_WEIGHT_SEVERITY_OFFSET, 0.8750f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_006_Chonky,         new BodyTypeInfo(0.065f + BASE_WEIGHT_SEVERITY_OFFSET, 1.1250f, 0.90f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_010a_Chubby,        new BodyTypeInfo(0.090f + BASE_WEIGHT_SEVERITY_OFFSET, 1.2500f, 0.80f, 1.28205f, 0.30f, 0.35f) },
                { RimRound.Defs.BodyTypeDefOf.F_020a_Corpulent,     new BodyTypeInfo(0.120f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.65f, 0.98205f, 0.40f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.F_030a_Fat,           new BodyTypeInfo(0.155f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.50f, 0.88205f, 0.44f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.F_040a_Obese,         new BodyTypeInfo(0.200f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.40f, 0.77205f, 0.50f, 0.40f) },
                { RimRound.Defs.BodyTypeDefOf.F_050a_MorbidlyObese, new BodyTypeInfo(0.280f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.30f, 0.65205f, 0.70f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.F_060a_Lardy,         new BodyTypeInfo(0.430f + BASE_WEIGHT_SEVERITY_OFFSET, 2.7500f, 0.20f, 0.58205f, 1.00f, 0.70f) },
                { RimRound.Defs.BodyTypeDefOf.F_070a_Enormous,      new BodyTypeInfo(0.660f + BASE_WEIGHT_SEVERITY_OFFSET, 2.5000f, 0.10f, 0.48205f, 0.93f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.F_080a_Gigantic,      new BodyTypeInfo(0.965f + BASE_WEIGHT_SEVERITY_OFFSET, 5.5000f, 0.10f, 0.38205f, 1.10f, 0.65f) },
                { RimRound.Defs.BodyTypeDefOf.F_090a_Titanic,       new BodyTypeInfo(1.410f + BASE_WEIGHT_SEVERITY_OFFSET, 5.2500f, 0.10f, 0.37205f, 1.10f, 0.79f) },
                { RimRound.Defs.BodyTypeDefOf.F_100a_Gelatinous,    new BodyTypeInfo(1.860f + BASE_WEIGHT_SEVERITY_OFFSET, 7.5000f, 0.05f, 0.22205f, 2.52f, 0.00f) },

                { RimRound.Defs.BodyTypeDefOf.F_150a_Gelatinous,    new BodyTypeInfo(2.460f + BASE_WEIGHT_SEVERITY_OFFSET, 8.5000f, 0.05f, 0.22205f, 2.52f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_200a_Gelatinous,    new BodyTypeInfo(2.960f + BASE_WEIGHT_SEVERITY_OFFSET, 9.5000f, 0.05f, 0.20205f, 2.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_250a_Gelatinous,    new BodyTypeInfo(3.960f + BASE_WEIGHT_SEVERITY_OFFSET, 10.500f, 0.05f, 0.17000f, 2.80f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_300a_Gelatinous,    new BodyTypeInfo(4.960f + BASE_WEIGHT_SEVERITY_OFFSET, 12.000f, 0.05f, 0.14000f, 3.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_350a_Gelatinous,    new BodyTypeInfo(6.460f + BASE_WEIGHT_SEVERITY_OFFSET, 13.000f, 0.05f, 0.13000f, 3.90f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_400a_Gelatinous,    new BodyTypeInfo(7.960f + BASE_WEIGHT_SEVERITY_OFFSET, 15.000f, 0.05f, 0.11000f, 4.70f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_450a_Gelatinous,    new BodyTypeInfo(9.960f + BASE_WEIGHT_SEVERITY_OFFSET, 17.000f, 0.05f, 0.10000f, 5.40f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_500a_Gelatinous,    new BodyTypeInfo(14.46f + BASE_WEIGHT_SEVERITY_OFFSET, 20.000f, 0.05f, 0.09000f, 6.31f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_900a_Gelatinous,    new BodyTypeInfo(21.85f + BASE_WEIGHT_SEVERITY_OFFSET  , 25.000f, 0.05f, 0.07000f, 7.11f, 0.00f) },

                { RimRound.Defs.BodyTypeDefOf.F_910a_Gelatinous,    new BodyTypeInfo(42.40f + BASE_WEIGHT_SEVERITY_OFFSET  , 30.000f, 0.05f, 0.06000f, 8.5f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_920a_Gelatinous,    new BodyTypeInfo(70.50f + BASE_WEIGHT_SEVERITY_OFFSET  , 40.000f, 0.05f, 0.05100f, 12f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_930a_Gelatinous,    new BodyTypeInfo(116.6f + BASE_WEIGHT_SEVERITY_OFFSET  , 55.000f, 0.05f, 0.03400f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_940a_Gelatinous,    new BodyTypeInfo(164.5f + BASE_WEIGHT_SEVERITY_OFFSET  , 70.000f, 0.05f, 0.02800f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_950a_Gelatinous,    new BodyTypeInfo(286.2f + BASE_WEIGHT_SEVERITY_OFFSET  , 85.000f, 0.05f, 0.02200f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_960a_Gelatinous,    new BodyTypeInfo(411.0f + BASE_WEIGHT_SEVERITY_OFFSET , 105.000f, 0.05f, 0.01800f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_970a_Gelatinous,    new BodyTypeInfo(576.7f + BASE_WEIGHT_SEVERITY_OFFSET , 125.000f, 0.05f, 0.01500f, 41f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_980a_Gelatinous,    new BodyTypeInfo(773.2f + BASE_WEIGHT_SEVERITY_OFFSET , 150.000f, 0.05f, 0.01200f, 41f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_990a_Gelatinous,    new BodyTypeInfo(999.9f + BASE_WEIGHT_SEVERITY_OFFSET , 175.000f, 0.05f, 0.00700f, 60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_995a_Gelatinous,    new BodyTypeInfo(10000f + BASE_WEIGHT_SEVERITY_OFFSET , 200.000f, 0.05f, 0.00700f, 60f, 0.00f) },
            };
        ...
        public static Dictionary<BodyTypeDef, BodyTypeInfo> defaultMaleSet = new Dictionary<BodyTypeDef, BodyTypeInfo>()
            {
                ...
                { RimWorld.BodyTypeDefOf.Thin,                     new BodyTypeInfo(0.015f + BASE_WEIGHT_SEVERITY_OFFSET, 1.0000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimWorld.BodyTypeDefOf.Male,                     new BodyTypeInfo(0.035f + BASE_WEIGHT_SEVERITY_OFFSET, 1.0000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.M_005_Thick,         new BodyTypeInfo(0.050f + BASE_WEIGHT_SEVERITY_OFFSET, 0.8750f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.M_006_Chonky,        new BodyTypeInfo(0.065f + BASE_WEIGHT_SEVERITY_OFFSET, 1.1250f, 0.90f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.M_010_Chubby,        new BodyTypeInfo(0.090f + BASE_WEIGHT_SEVERITY_OFFSET, 1.2500f, 0.80f, 1.28205f, 0.30f, 0.35f) },
                { RimRound.Defs.BodyTypeDefOf.M_020_Corpulent,     new BodyTypeInfo(0.120f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.65f, 0.98205f, 0.40f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.M_030_Fat,           new BodyTypeInfo(0.155f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.50f, 0.88205f, 0.44f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.M_040_Obese,         new BodyTypeInfo(0.200f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.40f, 0.77205f, 0.50f, 0.40f) },
                { RimRound.Defs.BodyTypeDefOf.M_050_MorbidlyObese, new BodyTypeInfo(0.280f + BASE_WEIGHT_SEVERITY_OFFSET, 1.3750f, 0.30f, 0.65205f, 0.70f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.M_060_Lardy,         new BodyTypeInfo(0.430f + BASE_WEIGHT_SEVERITY_OFFSET, 2.7500f, 0.20f, 0.58205f, 1.00f, 0.70f) },
                { RimRound.Defs.BodyTypeDefOf.M_070_Enormous,      new BodyTypeInfo(0.660f + BASE_WEIGHT_SEVERITY_OFFSET, 2.5000f, 0.10f, 0.48205f, 0.93f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.M_080_Gigantic,      new BodyTypeInfo(0.965f + BASE_WEIGHT_SEVERITY_OFFSET, 5.5000f, 0.10f, 0.38205f, 1.10f, 0.65f) },
                { RimRound.Defs.BodyTypeDefOf.M_090_Titanic,       new BodyTypeInfo(1.410f + BASE_WEIGHT_SEVERITY_OFFSET, 5.2500f, 0.10f, 0.37205f, 1.10f, 0.79f) },
                { RimRound.Defs.BodyTypeDefOf.M_100_Gelatinous,    new BodyTypeInfo(1.860f + BASE_WEIGHT_SEVERITY_OFFSET, 7.5000f, 0.05f, 0.22205f, 2.52f, 0.00f) },


                { RimRound.Defs.BodyTypeDefOf.M_150_Gelatinous,    new BodyTypeInfo(2.460f + BASE_WEIGHT_SEVERITY_OFFSET, 8.5000f, 0.05f, 0.22205f, 2.52f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_200_Gelatinous,    new BodyTypeInfo(2.960f + BASE_WEIGHT_SEVERITY_OFFSET, 9.5000f, 0.05f, 0.20205f, 2.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_250_Gelatinous,    new BodyTypeInfo(3.960f + BASE_WEIGHT_SEVERITY_OFFSET, 10.500f, 0.05f, 0.17000f, 2.80f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_300_Gelatinous,    new BodyTypeInfo(4.960f + BASE_WEIGHT_SEVERITY_OFFSET, 12.000f, 0.05f, 0.14000f, 3.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_350_Gelatinous,    new BodyTypeInfo(6.460f + BASE_WEIGHT_SEVERITY_OFFSET, 13.000f, 0.05f, 0.13000f, 3.90f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_400_Gelatinous,    new BodyTypeInfo(7.960f + BASE_WEIGHT_SEVERITY_OFFSET, 15.000f, 0.05f, 0.11000f, 4.70f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_450_Gelatinous,    new BodyTypeInfo(9.960f + BASE_WEIGHT_SEVERITY_OFFSET, 17.000f, 0.05f, 0.10000f, 5.40f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_500_Gelatinous,    new BodyTypeInfo(14.46f + BASE_WEIGHT_SEVERITY_OFFSET, 20.000f, 0.05f, 0.09000f, 6.31f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_900_Gelatinous,    new BodyTypeInfo(21.85f + BASE_WEIGHT_SEVERITY_OFFSET, 25.000f, 0.05f, 0.07000f, 7.11f, 0.00f) },

                { RimRound.Defs.BodyTypeDefOf.M_910_Gelatinous,    new BodyTypeInfo(42.40f + BASE_WEIGHT_SEVERITY_OFFSET  , 30.000f, 0.05f, 0.06000f, 8.5f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_920_Gelatinous,    new BodyTypeInfo(70.50f + BASE_WEIGHT_SEVERITY_OFFSET  , 40.000f, 0.05f, 0.05100f, 12f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_930_Gelatinous,    new BodyTypeInfo(116.6f + BASE_WEIGHT_SEVERITY_OFFSET  , 55.000f, 0.05f, 0.03400f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_940_Gelatinous,    new BodyTypeInfo(164.5f + BASE_WEIGHT_SEVERITY_OFFSET  , 70.000f, 0.05f, 0.02800f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_950_Gelatinous,    new BodyTypeInfo(286.2f + BASE_WEIGHT_SEVERITY_OFFSET  , 85.000f, 0.05f, 0.02200f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_960_Gelatinous,    new BodyTypeInfo(411.0f + BASE_WEIGHT_SEVERITY_OFFSET , 105.000f, 0.05f, 0.01800f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_970_Gelatinous,    new BodyTypeInfo(576.7f + BASE_WEIGHT_SEVERITY_OFFSET , 125.000f, 0.05f, 0.01500f, 41f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_980_Gelatinous,    new BodyTypeInfo(773.2f + BASE_WEIGHT_SEVERITY_OFFSET , 150.000f, 0.05f, 0.01200f, 41f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_990_Gelatinous,    new BodyTypeInfo(999.9f + BASE_WEIGHT_SEVERITY_OFFSET , 175.000f, 0.05f, 0.00700f, 60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_995_Gelatinous,    new BodyTypeInfo(10000f + BASE_WEIGHT_SEVERITY_OFFSET , 200.000f, 0.05f, 0.00700f, 60f, 0.00f) },
        };
        ...
        public static Dictionary<BodyTypeDef, BodyTypeInfo> set090Female = new Dictionary<BodyTypeDef, BodyTypeInfo>()
            {
                ...
                { RimRound.Defs.BodyTypeDefOf.F_002_Emaciated,     new BodyTypeInfo(-0.010f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_003_Starved,       new BodyTypeInfo(-0.005f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_004_Scrawny,       new BodyTypeInfo(0.005f + BASE_WEIGHT_SEVERITY_OFFSET, 0.9000f, 1.00f, 1.28205f, 0.30f, 0.30f) },

                { RimWorld.BodyTypeDefOf.Thin,                            new BodyTypeInfo(0.015f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimWorld.BodyTypeDefOf.Female,                          new BodyTypeInfo(0.035f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_005_Thick_090,            new BodyTypeInfo(0.050f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.6875f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_006_Chonky_090,           new BodyTypeInfo(0.065f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.90f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_010_Chubby_090,           new BodyTypeInfo(0.090f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.80f, 1.28205f, 0.30f, 0.35f) },
                { RimRound.Defs.BodyTypeDefOf.F_020_Corpulent_090,        new BodyTypeInfo(0.120f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.65f, 0.98205f, 0.40f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.F_030_Fat_090,              new BodyTypeInfo(0.155f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.000f, 0.50f, 0.88205f, 0.44f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.F_040_Obese_090,            new BodyTypeInfo(0.200f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.125f, 0.40f, 0.77205f, 0.50f, 0.40f) },
                { RimRound.Defs.BodyTypeDefOf.F_050_MorbidlyObese_090,    new BodyTypeInfo(0.280f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.125f, 0.30f, 0.65205f, 0.70f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.F_060_Lardy_090,            new BodyTypeInfo(0.430f+ BASE_WEIGHT_SEVERITY_OFFSET, 2.125f, 0.20f, 0.58205f, 1.00f, 0.70f) },
                { RimRound.Defs.BodyTypeDefOf.F_070_Enormous_090,         new BodyTypeInfo(0.660f+ BASE_WEIGHT_SEVERITY_OFFSET, 2.000f, 0.10f, 0.48205f, 0.93f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.F_080_Gigantic_090,         new BodyTypeInfo(0.965f+ BASE_WEIGHT_SEVERITY_OFFSET, 3.875f, 0.10f, 0.38205f, 1.10f, 0.65f) },
                { RimRound.Defs.BodyTypeDefOf.F_090_Titanic_090,          new BodyTypeInfo(1.410f+ BASE_WEIGHT_SEVERITY_OFFSET, 3.875f, 0.10f, 0.37205f, 1.10f, 0.79f) },
                { RimRound.Defs.BodyTypeDefOf.F_100_Gelatinous_090,       new BodyTypeInfo(1.860f+ BASE_WEIGHT_SEVERITY_OFFSET, 5.000f, 0.05f, 0.22205f, 2.52f, 0.00f) },


                { RimRound.Defs.BodyTypeDefOf.F_150_Gelatinous_090,    new BodyTypeInfo(2.460f + BASE_WEIGHT_SEVERITY_OFFSET, 5.5000f, 0.05f, 0.22205f, 2.52f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_200_Gelatinous_090,    new BodyTypeInfo(2.960f + BASE_WEIGHT_SEVERITY_OFFSET, 6.2500f, 0.05f, 0.20205f, 2.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_250_Gelatinous_090,    new BodyTypeInfo(3.960f + BASE_WEIGHT_SEVERITY_OFFSET, 7.0000f, 0.05f, 0.17000f, 2.80f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_300_Gelatinous_090,    new BodyTypeInfo(4.960f + BASE_WEIGHT_SEVERITY_OFFSET, 7.7500f, 0.05f, 0.14000f, 3.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_350_Gelatinous_090,    new BodyTypeInfo(6.460f + BASE_WEIGHT_SEVERITY_OFFSET, 8.5000f, 0.05f, 0.13000f, 3.90f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_400_Gelatinous_090,    new BodyTypeInfo(7.960f + BASE_WEIGHT_SEVERITY_OFFSET, 9.5000f, 0.05f, 0.11000f, 4.70f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_450_Gelatinous_090,    new BodyTypeInfo(9.960f + BASE_WEIGHT_SEVERITY_OFFSET, 11.000f, 0.05f, 0.10000f, 5.40f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_500_Gelatinous_090,    new BodyTypeInfo(14.46f + BASE_WEIGHT_SEVERITY_OFFSET, 13.000f, 0.05f, 0.09000f, 6.31f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_900_Gelatinous_090,    new BodyTypeInfo(21.85f + BASE_WEIGHT_SEVERITY_OFFSET, 17.000f, 0.05f, 0.07000f, 7.11f, 0.00f) },

                { RimRound.Defs.BodyTypeDefOf.F_910_Gelatinous_090,    new BodyTypeInfo(42.40f + BASE_WEIGHT_SEVERITY_OFFSET , 20.000f, 0.05f, 0.09000f, 6.31f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_920_Gelatinous_090,    new BodyTypeInfo(70.50f + BASE_WEIGHT_SEVERITY_OFFSET , 25.000f, 0.05f, 0.07000f, 7.11f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_930_Gelatinous_090,    new BodyTypeInfo(116.6f + BASE_WEIGHT_SEVERITY_OFFSET , 30.000f, 0.05f, 0.06000f, 8.5f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_940_Gelatinous_090,    new BodyTypeInfo(164.5f + BASE_WEIGHT_SEVERITY_OFFSET , 40.000f, 0.05f, 0.05100f, 12f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_950_Gelatinous_090,    new BodyTypeInfo(286.2f + BASE_WEIGHT_SEVERITY_OFFSET , 55.000f, 0.05f, 0.03400f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_960_Gelatinous_090,    new BodyTypeInfo(411.0f + BASE_WEIGHT_SEVERITY_OFFSET,  70.000f, 0.05f, 0.02800f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_970_Gelatinous_090,    new BodyTypeInfo(576.7f + BASE_WEIGHT_SEVERITY_OFFSET,  85.000f, 0.05f, 0.02200f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_980_Gelatinous_090,    new BodyTypeInfo(773.2f + BASE_WEIGHT_SEVERITY_OFFSET, 105.000f, 0.05f, 0.01800f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_990_Gelatinous_090,    new BodyTypeInfo(999.9f + BASE_WEIGHT_SEVERITY_OFFSET, 125.000f, 0.05f, 0.01500f, 41f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_995_Gelatinous_090,    new BodyTypeInfo(10000f + BASE_WEIGHT_SEVERITY_OFFSET, 150.000f, 0.05f, 0.01200f, 41f, 0.00f) },
        ...
        public static Dictionary<BodyTypeDef, BodyTypeInfo> set090FemaleApple = new Dictionary<BodyTypeDef, BodyTypeInfo>()
            {
                ...
                { RimRound.Defs.BodyTypeDefOf.F_005_Thick_090,            new BodyTypeInfo(0.050f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.6875f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_006_Chonky_090,           new BodyTypeInfo(0.065f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.90f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_010a_Chubby_090,           new BodyTypeInfo(0.090f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.80f, 1.28205f, 0.30f, 0.35f) },
                { RimRound.Defs.BodyTypeDefOf.F_020a_Corpulent_090,        new BodyTypeInfo(0.120f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.65f, 0.98205f, 0.40f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.F_030a_Fat_090,              new BodyTypeInfo(0.155f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.000f, 0.50f, 0.88205f, 0.44f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.F_040a_Obese_090,            new BodyTypeInfo(0.200f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.125f, 0.40f, 0.77205f, 0.50f, 0.40f) },
                { RimRound.Defs.BodyTypeDefOf.F_050a_MorbidlyObese_090,    new BodyTypeInfo(0.280f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.125f, 0.30f, 0.65205f, 0.70f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.F_060a_Lardy_090,            new BodyTypeInfo(0.430f+ BASE_WEIGHT_SEVERITY_OFFSET, 2.125f, 0.20f, 0.58205f, 1.00f, 0.70f) },
                { RimRound.Defs.BodyTypeDefOf.F_070a_Enormous_090,         new BodyTypeInfo(0.660f+ BASE_WEIGHT_SEVERITY_OFFSET, 2.000f, 0.10f, 0.48205f, 0.93f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.F_080a_Gigantic_090,         new BodyTypeInfo(0.965f+ BASE_WEIGHT_SEVERITY_OFFSET, 3.875f, 0.10f, 0.38205f, 1.10f, 0.65f) },
                { RimRound.Defs.BodyTypeDefOf.F_090a_Titanic_090,          new BodyTypeInfo(1.410f+ BASE_WEIGHT_SEVERITY_OFFSET, 3.875f, 0.10f, 0.37205f, 1.10f, 0.79f) },
                { RimRound.Defs.BodyTypeDefOf.F_100a_Gelatinous_090,       new BodyTypeInfo(1.860f+ BASE_WEIGHT_SEVERITY_OFFSET, 5.000f, 0.05f, 0.22205f, 2.52f, 0.00f) },


                { RimRound.Defs.BodyTypeDefOf.F_150a_Gelatinous_090,    new BodyTypeInfo(2.460f+ BASE_WEIGHT_SEVERITY_OFFSET, 5.5000f, 0.05f, 0.22205f, 2.52f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_200a_Gelatinous_090,    new BodyTypeInfo(2.960f+ BASE_WEIGHT_SEVERITY_OFFSET, 6.2500f, 0.05f, 0.20205f, 2.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_250a_Gelatinous_090,    new BodyTypeInfo(3.960f+ BASE_WEIGHT_SEVERITY_OFFSET, 7.0000f, 0.05f, 0.17000f, 2.80f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_300a_Gelatinous_090,    new BodyTypeInfo(4.960f+ BASE_WEIGHT_SEVERITY_OFFSET, 7.7500f, 0.05f, 0.14000f, 3.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_350a_Gelatinous_090,    new BodyTypeInfo(6.460f+ BASE_WEIGHT_SEVERITY_OFFSET, 8.5000f, 0.05f, 0.13000f, 3.90f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_400a_Gelatinous_090,    new BodyTypeInfo(7.960f+ BASE_WEIGHT_SEVERITY_OFFSET, 9.5000f, 0.05f, 0.11000f, 4.70f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_450a_Gelatinous_090,    new BodyTypeInfo(9.960f+ BASE_WEIGHT_SEVERITY_OFFSET, 11.000f, 0.05f, 0.10000f, 5.40f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_500a_Gelatinous_090,    new BodyTypeInfo(14.46f+ BASE_WEIGHT_SEVERITY_OFFSET, 13.000f, 0.05f, 0.09000f, 6.31f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_900a_Gelatinous_090,    new BodyTypeInfo(21.85f+ BASE_WEIGHT_SEVERITY_OFFSET, 17.000f, 0.05f, 0.07000f, 7.11f, 0.00f) },

                { RimRound.Defs.BodyTypeDefOf.F_910a_Gelatinous_090,    new BodyTypeInfo(42.40f + BASE_WEIGHT_SEVERITY_OFFSET , 20.000f, 0.05f, 0.09000f, 6.31f, 0.0f) },
                { RimRound.Defs.BodyTypeDefOf.F_920a_Gelatinous_090,    new BodyTypeInfo(70.50f + BASE_WEIGHT_SEVERITY_OFFSET , 25.000f, 0.05f, 0.07000f, 7.11f, 0.0f) },
                { RimRound.Defs.BodyTypeDefOf.F_930a_Gelatinous_090,    new BodyTypeInfo(116.6f + BASE_WEIGHT_SEVERITY_OFFSET , 30.000f, 0.05f, 0.06000f, 8.5f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_940a_Gelatinous_090,    new BodyTypeInfo(164.5f + BASE_WEIGHT_SEVERITY_OFFSET , 40.000f, 0.05f, 0.05100f, 12f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_950a_Gelatinous_090,    new BodyTypeInfo(286.2f + BASE_WEIGHT_SEVERITY_OFFSET , 55.000f, 0.05f, 0.03400f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_960a_Gelatinous_090,    new BodyTypeInfo(411.0f + BASE_WEIGHT_SEVERITY_OFFSET,  70.000f, 0.05f, 0.02800f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_970a_Gelatinous_090,    new BodyTypeInfo(576.7f + BASE_WEIGHT_SEVERITY_OFFSET,  85.000f, 0.05f, 0.02200f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_980a_Gelatinous_090,    new BodyTypeInfo(773.2f + BASE_WEIGHT_SEVERITY_OFFSET, 105.000f, 0.05f, 0.01800f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_990a_Gelatinous_090,    new BodyTypeInfo(999.9f + BASE_WEIGHT_SEVERITY_OFFSET, 125.000f, 0.05f, 0.01500f, 41f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_995a_Gelatinous_090,    new BodyTypeInfo(10000f + BASE_WEIGHT_SEVERITY_OFFSET, 150.000f, 0.05f, 0.01200f, 41f, 0.00f) },
        ...
        public static Dictionary<BodyTypeDef, BodyTypeInfo> set090Male = new Dictionary<BodyTypeDef, BodyTypeInfo>()
            {
                ...
                { RimWorld.BodyTypeDefOf.Thin,                            new BodyTypeInfo(0.015f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimWorld.BodyTypeDefOf.Male,                            new BodyTypeInfo(0.035f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9000f, 1.00f, 1.28205f, 0.30f, 0.30f) },

                { RimRound.Defs.BodyTypeDefOf.M_005_Thick_090,            new BodyTypeInfo(0.050f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.6875f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.M_006_Chonky_090,           new BodyTypeInfo(0.065f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.90f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.M_010_Chubby_090,           new BodyTypeInfo(0.090f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.80f, 1.28205f, 0.30f, 0.35f) },
                { RimRound.Defs.BodyTypeDefOf.M_020_Corpulent_090,        new BodyTypeInfo(0.120f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.65f, 0.98205f, 0.40f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.M_030_Fat_090,              new BodyTypeInfo(0.155f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.000f, 0.50f, 0.88205f, 0.44f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.M_040_Obese_090,            new BodyTypeInfo(0.200f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.125f, 0.40f, 0.77205f, 0.50f, 0.40f) },
                { RimRound.Defs.BodyTypeDefOf.M_050_MorbidlyObese_090,    new BodyTypeInfo(0.280f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.125f, 0.30f, 0.65205f, 0.70f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.M_060_Lardy_090,            new BodyTypeInfo(0.430f+ BASE_WEIGHT_SEVERITY_OFFSET, 2.125f, 0.20f, 0.58205f, 1.00f, 0.70f) },
                { RimRound.Defs.BodyTypeDefOf.M_070_Enormous_090,         new BodyTypeInfo(0.660f+ BASE_WEIGHT_SEVERITY_OFFSET, 2.000f, 0.10f, 0.48205f, 0.93f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.M_080_Gigantic_090,         new BodyTypeInfo(0.965f+ BASE_WEIGHT_SEVERITY_OFFSET, 3.875f, 0.10f, 0.38205f, 1.10f, 0.65f) },
                { RimRound.Defs.BodyTypeDefOf.M_090_Titanic_090,          new BodyTypeInfo(1.410f+ BASE_WEIGHT_SEVERITY_OFFSET, 3.875f, 0.10f, 0.37205f, 1.10f, 0.79f) },
                { RimRound.Defs.BodyTypeDefOf.M_100_Gelatinous_090,       new BodyTypeInfo(1.860f+ BASE_WEIGHT_SEVERITY_OFFSET, 5.000f, 0.05f, 0.22205f, 2.52f, 0.00f) },


                { RimRound.Defs.BodyTypeDefOf.M_150_Gelatinous_090,    new BodyTypeInfo(2.460f+ BASE_WEIGHT_SEVERITY_OFFSET, 5.5000f, 0.05f, 0.22205f, 2.52f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_200_Gelatinous_090,    new BodyTypeInfo(2.960f+ BASE_WEIGHT_SEVERITY_OFFSET, 6.2500f, 0.05f, 0.20205f, 2.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_250_Gelatinous_090,    new BodyTypeInfo(3.960f+ BASE_WEIGHT_SEVERITY_OFFSET, 7.0000f, 0.05f, 0.17000f, 2.80f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_300_Gelatinous_090,    new BodyTypeInfo(4.960f+ BASE_WEIGHT_SEVERITY_OFFSET, 7.7500f, 0.05f, 0.14000f, 3.60f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_350_Gelatinous_090,    new BodyTypeInfo(6.460f+ BASE_WEIGHT_SEVERITY_OFFSET, 8.5000f, 0.05f, 0.13000f, 3.90f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_400_Gelatinous_090,    new BodyTypeInfo(7.960f+ BASE_WEIGHT_SEVERITY_OFFSET, 9.5000f, 0.05f, 0.11000f, 4.70f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_450_Gelatinous_090,    new BodyTypeInfo(9.960f+ BASE_WEIGHT_SEVERITY_OFFSET, 11.000f, 0.05f, 0.10000f, 5.40f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_500_Gelatinous_090,    new BodyTypeInfo(14.46f+ BASE_WEIGHT_SEVERITY_OFFSET, 13.000f, 0.05f, 0.09000f, 6.31f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_900_Gelatinous_090,    new BodyTypeInfo(21.85f+ BASE_WEIGHT_SEVERITY_OFFSET, 17.000f, 0.05f, 0.07000f, 7.11f, 0.00f) },

                { RimRound.Defs.BodyTypeDefOf.M_910_Gelatinous_090,    new BodyTypeInfo(42.40f + BASE_WEIGHT_SEVERITY_OFFSET , 20.000f, 0.05f, 0.09000f, 6.31f, 0.0f) },
                { RimRound.Defs.BodyTypeDefOf.M_920_Gelatinous_090,    new BodyTypeInfo(70.50f + BASE_WEIGHT_SEVERITY_OFFSET , 25.000f, 0.05f, 0.07000f, 7.11f, 0.0f) },
                { RimRound.Defs.BodyTypeDefOf.M_930_Gelatinous_090,    new BodyTypeInfo(116.6f + BASE_WEIGHT_SEVERITY_OFFSET , 30.000f, 0.05f, 0.06000f, 8.5f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_940_Gelatinous_090,    new BodyTypeInfo(164.5f + BASE_WEIGHT_SEVERITY_OFFSET , 40.000f, 0.05f, 0.05100f, 12f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_950_Gelatinous_090,    new BodyTypeInfo(286.2f + BASE_WEIGHT_SEVERITY_OFFSET , 55.000f, 0.05f, 0.03400f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_960_Gelatinous_090,    new BodyTypeInfo(411.0f + BASE_WEIGHT_SEVERITY_OFFSET,  70.000f, 0.05f, 0.02800f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_970_Gelatinous_090,    new BodyTypeInfo(576.7f + BASE_WEIGHT_SEVERITY_OFFSET,  85.000f, 0.05f, 0.02200f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_980_Gelatinous_090,    new BodyTypeInfo(773.2f + BASE_WEIGHT_SEVERITY_OFFSET, 105.000f, 0.05f, 0.01800f, 29f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_990_Gelatinous_090,    new BodyTypeInfo(999.9f + BASE_WEIGHT_SEVERITY_OFFSET, 125.000f, 0.05f, 0.01500f, 41f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.M_995_Gelatinous_090,    new BodyTypeInfo(10000f + BASE_WEIGHT_SEVERITY_OFFSET, 150.000f, 0.05f, 0.01200f, 41f, 0.00f) },
        ...
        public static Dictionary<BodyTypeDef, BodyTypeInfo> set070Female = new Dictionary<BodyTypeDef, BodyTypeInfo>()
            {
                ...
                { RimRound.Defs.BodyTypeDefOf.F_002_Emaciated,     new BodyTypeInfo(-0.010f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_003_Starved,       new BodyTypeInfo(-0.005f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_004_Scrawny,       new BodyTypeInfo(0.005f + BASE_WEIGHT_SEVERITY_OFFSET, 0.7000f, 1.00f, 1.28205f, 0.30f, 0.30f) },

                { RimWorld.BodyTypeDefOf.Thin,                            new BodyTypeInfo(0.015f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimWorld.BodyTypeDefOf.Female,                          new BodyTypeInfo(0.035f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7000f, 1.00f, 1.28205f, 0.30f, 0.30f) },

                { RimRound.Defs.BodyTypeDefOf.F_005_Thick_070,                new BodyTypeInfo(0.050f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.5625f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_006_Chonky_070,               new BodyTypeInfo(0.065f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.90f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_010_Chubby_070,               new BodyTypeInfo(0.090f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.80f, 1.28205f, 0.30f, 0.35f) },
                { RimRound.Defs.BodyTypeDefOf.F_020_Corpulent_070,            new BodyTypeInfo(0.120f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.65f, 0.98205f, 0.40f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.F_030_Fat_070,                  new BodyTypeInfo(0.155f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.50f, 0.88205f, 0.44f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.F_040_Obese_070,                new BodyTypeInfo(0.200f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.40f, 0.77205f, 0.50f, 0.40f) },
                { RimRound.Defs.BodyTypeDefOf.F_050_MorbidlyObese_070,        new BodyTypeInfo(0.280f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.30f, 0.65205f, 0.70f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.F_060_Lardy_070,                new BodyTypeInfo(0.430f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.6250f, 0.20f, 0.58205f, 1.00f, 0.70f) },
                { RimRound.Defs.BodyTypeDefOf.F_070_Enormous_070,             new BodyTypeInfo(0.660f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.5000f, 0.10f, 0.48205f, 0.93f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.F_080_Gigantic_070,             new BodyTypeInfo(0.965f+ BASE_WEIGHT_SEVERITY_OFFSET, 2.8750f, 0.10f, 0.38205f, 1.10f, 0.65f) },
                { RimRound.Defs.BodyTypeDefOf.F_090_Titanic_070,              new BodyTypeInfo(1.410f+ BASE_WEIGHT_SEVERITY_OFFSET, 2.8750f, 0.10f, 0.37205f, 1.10f, 0.79f) },
                { RimRound.Defs.BodyTypeDefOf.F_100_Gelatinous_070,           new BodyTypeInfo(100f + BASE_WEIGHT_SEVERITY_OFFSET , 3.6250f, 0.05f, 0.22205f, 2.52f, 0.00f) }
            };
        ...
        public static Dictionary<BodyTypeDef, BodyTypeInfo> set070Male = new Dictionary<BodyTypeDef, BodyTypeInfo>()
            {
                ...
                { RimWorld.BodyTypeDefOf.Thin,                            new BodyTypeInfo(0.015f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimWorld.BodyTypeDefOf.Male,                            new BodyTypeInfo(0.035f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.M_005_Thick_070,                new BodyTypeInfo(0.050f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.6250f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.M_006_Chonky_070,               new BodyTypeInfo(0.065f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.90f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.M_010_Chubby_070,               new BodyTypeInfo(0.090f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.80f, 1.28205f, 0.30f, 0.35f) },
                { RimRound.Defs.BodyTypeDefOf.M_020_Corpulent_070,            new BodyTypeInfo(0.120f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.65f, 0.98205f, 0.40f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.M_030_Fat_070,                  new BodyTypeInfo(0.155f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.50f, 0.88205f, 0.44f, 0.45f) },
                { RimRound.Defs.BodyTypeDefOf.M_040_Obese_070,                new BodyTypeInfo(0.200f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.40f, 0.77205f, 0.50f, 0.40f) },
                { RimRound.Defs.BodyTypeDefOf.M_050_MorbidlyObese_070,        new BodyTypeInfo(0.280f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.7500f, 0.30f, 0.65205f, 0.70f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.M_060_Lardy_070,                new BodyTypeInfo(0.430f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.6250f, 0.20f, 0.58205f, 1.00f, 0.70f) },
                { RimRound.Defs.BodyTypeDefOf.M_070_Enormous_070,             new BodyTypeInfo(0.660f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.5000f, 0.10f, 0.48205f, 0.93f, 0.50f) },
                { RimRound.Defs.BodyTypeDefOf.M_080_Gigantic_070,             new BodyTypeInfo(0.965f+ BASE_WEIGHT_SEVERITY_OFFSET, 2.8750f, 0.10f, 0.38205f, 1.10f, 0.65f) },
                { RimRound.Defs.BodyTypeDefOf.M_090_Titanic_070,              new BodyTypeInfo(1.410f+ BASE_WEIGHT_SEVERITY_OFFSET, 2.8750f, 0.10f, 0.37205f, 1.10f, 0.79f) },
                { RimRound.Defs.BodyTypeDefOf.M_100_Gelatinous_070,           new BodyTypeInfo(100f  + BASE_WEIGHT_SEVERITY_OFFSET, 3.6250f, 0.05f, 0.22205f, 2.52f, 0.00f) }
            };
        ...
        public static Dictionary<BodyTypeDef, BodyTypeInfo> set090FemaleNoFemaleSprite = new Dictionary<BodyTypeDef, BodyTypeInfo>()
            {
                ...
                { RimRound.Defs.BodyTypeDefOf.F_910_Gelatinous_090,    new BodyTypeInfo(42.40f + BASE_WEIGHT_SEVERITY_OFFSET , 20.000f, 0.05f, 0.09000f, 6.31f, 0.0f) },
                { RimRound.Defs.BodyTypeDefOf.F_920_Gelatinous_090,    new BodyTypeInfo(70.50f + BASE_WEIGHT_SEVERITY_OFFSET , 25.000f, 0.05f, 0.07000f, 7.11f, 0.0f) },
                { RimRound.Defs.BodyTypeDefOf.F_930_Gelatinous_090,    new BodyTypeInfo(116.6f + BASE_WEIGHT_SEVERITY_OFFSET , 30.000f, 0.05f, 0.06000f, 8.5f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_940_Gelatinous_090,    new BodyTypeInfo(164.5f + BASE_WEIGHT_SEVERITY_OFFSET , 40.000f, 0.05f, 0.05100f, 12f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_950_Gelatinous_090,    new BodyTypeInfo(286.2f + BASE_WEIGHT_SEVERITY_OFFSET , 55.000f, 0.05f, 0.03400f, 19f, 0.00f) },
                { RimRound.Defs.BodyTypeDefOf.F_960_Gelatinous_090,    new BodyTypeInfo(411.0f + BASE_WEIGHT_SEVERITY_OFFSET,  70.000f, 0.05f, 0.02800f, 19f, 0.00f) },
        ...
        public static Dictionary<BodyTypeDef, BodyTypeInfo> set090FemaleNoFemaleStandardThin = new Dictionary<BodyTypeDef, BodyTypeInfo>()
            {
                ...
                { RimRound.Defs.BodyTypeDefOf.F_002_Emaciated,     new BodyTypeInfo(-0.010f+ BASE_WEIGHT_SEVERITY_OFFSET,1.000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_003_Starved,       new BodyTypeInfo(-0.005f+ BASE_WEIGHT_SEVERITY_OFFSET,1.000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_004_Scrawny,       new BodyTypeInfo(0.005f + BASE_WEIGHT_SEVERITY_OFFSET,1.000f, 1.00f, 1.28205f, 0.30f, 0.30f) },

                { RimWorld.BodyTypeDefOf.Thin,                            new BodyTypeInfo(0.015f+ BASE_WEIGHT_SEVERITY_OFFSET, 1.000f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_005_Thick_090,            new BodyTypeInfo(0.050f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.6875f, 1.00f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_006_Chonky_090,           new BodyTypeInfo(0.065f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.90f, 1.28205f, 0.30f, 0.30f) },
                { RimRound.Defs.BodyTypeDefOf.F_010_Chubby_090,           new BodyTypeInfo(0.090f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.80f, 1.28205f, 0.30f, 0.35f) },
                { RimRound.Defs.BodyTypeDefOf.F_020_Corpulent_090,        new BodyTypeInfo(0.120f+ BASE_WEIGHT_SEVERITY_OFFSET, 0.9375f, 0.65f, 0.98205f, 0.40f, 0.45f) },
        ...
        static Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>> GS_Bear_Brown_Set = new Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>>(defaultSet);
        static Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>> GS_Bear_Panda_Set = new Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>>(defaultSet);
        static Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>> GS_Bear_Polar_Set = new Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>>(defaultSet);
        static Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>> GS_Bear_Luna_Set = new Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>>(defaultSet);
        static Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>> GS_Bear_Cave_Set = new Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>>(defaultSet);
        ...
        public static Dictionary<string, Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>>> raceToProperDictDictionary = new Dictionary<string, Dictionary<Gender, Dictionary<BodyArchetype, Dictionary<BodyTypeDef, BodyTypeInfo>>>>()
        {
            ...
            {"GS_Bear_Brown", GS_Bear_Brown_Set },
            {"GS_Bear_Panda", GS_Bear_Panda_Set },
            {"GS_Bear_Polar", GS_Bear_Polar_Set },
            {"GS_Bear_Luna", GS_Bear_Luna_Set },
            {"GS_Bear_Cave", GS_Bear_Cave_Set },
        ...
        {
            RimRound.Defs.BodyTypeDefOf.F_002_Emaciated,
            RimRound.Defs.BodyTypeDefOf.F_003_Starved,
            RimRound.Defs.BodyTypeDefOf.F_004_Scrawny,
